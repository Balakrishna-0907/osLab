...
## SOURCE CODE :
**File :** [file_operation.c](https://github.com/Balakrishna-0907/osLab/blob/83f875a513e85e4afe397fe52eb569c56e88207b/ex03/fileOperation.c)

## Compilation

```bash
gcc file_operation.c -o file_operation.c
```
